...
=======
var LivePersonVirtualAssistantModule=(function(){var _version='3.0.0';var _config={FIXED_LANGUAGE:!0,DEFAULT_LANGUAGE:'en',COUNTRY_CODE_LOCATION:'cstatus',USING_PROXY_BUTTON:!0,TRIGGER_CHAT_BUTTON_FROM_BUSY_STATE:!1,TRIGGER_CHAT_BUTTON_FROM_OFFLINE_STATE:!1,SEND_FAQ_CONVERSATION_AS_PRECHAT_LINES:!0,PRECHAT_LINES_INTRO_MESSAGE_ENABLED:!0,EMBEDDED_BUTTON_ID_LOADED:null,EMBEDDED_BUTTON_TYPE:5,EMBEDDED_BUTTON_INFO:null,ENGAGEMENT_NAME_SHORTCODE:':vap:',EMBEDDED_BUTTON_DIV_CONTAINER_ID:'lpButtonDiv-need-help-panel',WINDOW_CLOSE_BUTTON_CLASS:'lp_close',NAMESPACE:'LP_VA_PANEL_MODULE',EVENTS:{BUTTON_IMPRESSION:'EMBEDDED_BUTTON_IMPRESSION',SHOW:'SHOULD_SHOW_VA_PANEL',HIDE:'SHOULD_HIDE_VA_PANEL',BUTTON_TO_DISPLAY:'SHOULD_SHOW_BUTTON_CONTENT',CLOSE_THANKYOU_WINDOW:'DID_CLOSE_THANKYOU_WINDOW'}};var _supportedLanguages=['en'];var _abandonedChatEvents=['waiting','preChat','chatting','postChat'];var _translations={'default':{'intro':'Your conversation history so far ...','suffix':'An Agent will be with you shortly ...'},'en':{'intro':'Your conversation history so far ...','suffix':'An Agent will be with you shortly ...'}};var BUTTON_STATES={'ONLINE':1,'OFFLINE':2,'BUSY':4,'UNKNOWN':0};var BUTTON_STATE_DESCRIPTIONS={1:'ONLINE',2:'OFFLINE',4:'BUSY',0:'UNKNOWN',};var _eventBindingsDone=!1;var _eventLog=[];function _log(name,event){_eventLog.push({'name':name,'info':event,'timestamp':Date.now()})}
>>>>>>> hsbc-msbank/stable
...
=======
function triggerChatButtonClick(faqHistorySoFar){var clicked;if(lpTag&&lpTag.taglets&&lpTag.taglets.rendererStub){if(_config.SEND_FAQ_CONVERSATION_AS_PRECHAT_LINES&&faqHistorySoFar.length>0){var currentLanguage=_config.FIXED_LANGUAGE?_config.DEFAULT_LANGUAGE:getCurrentLanguageSelection();var translations=isSupportedLanguage(currentLanguage)?getLanguageTranslations(currentLanguage):null;var preChatLinesArray=[];if(translations&&translations.intro){preChatLinesArray.push(translations.intro)}else{console.log('[LP VA Module] ==> unsupported language OR no INTRO translations found for current languages : ',currentLanguage)}
>>>>>>> hsbc-msbank/stable
